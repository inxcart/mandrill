...
class Senders
{
     ...
     *     - return[] mixed the information on each sending address in the account
     ...
     *     - return[] mixed the information on each sending domain for the account
     ...
     *         - spf mixed details about the domain's SPF record
     ...
     *         - dkim mixed details about the domain's DKIM record
     ...
     *     - opens integer the total number of times messages by this sender have been opened
     *     - clicks integer the total number of times tracked URLs in messages by this sender have been clicked
     *     - stats mixed an aggregate summary of the sender's sending stats
     *         - today mixed stats for this sender so far today
     ...
     *         - last_7_days mixed stats for this sender in the last 7 days
     ...
     *         - last_30_days mixed stats for this sender in the last 30 days
     ...
     *         - last_60_days mixed stats for this sender in the last 60 days
     ...
     *         - last_90_days mixed stats for this sender in the last 90 days
