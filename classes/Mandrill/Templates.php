...
class Templates
{
     ...
     *
     * @return array an array of mixeds with information about each template
     *     - return[] mixed the information on each template in the account
     *         - slug string the immutable unique code name of the template
     *         - name string the name of the template
     *         - labels array the list of labels applied to the template
     *             - labels[] string a single label
     ...
     * @param array  $template_content an array of template content to render.  Each item in the array should be a mixed with two keys - name: the name of the content block to set the content for, and content: the actual content to put into the block
     ...
     *                                 - merge_vars[] mixed a single merge variable
