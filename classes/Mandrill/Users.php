...
class Users
{
     ...
     *     - stats mixed an aggregate summary of the account's sending stats
     *         - today mixed stats for this user so far today
     ...
     *         - last_7_days mixed stats for this user in the last 7 days
     ...
     *         - last_30_days mixed stats for this user in the last 30 days
     ...
     *         - last_60_days mixed stats for this user in the last 60 days
     ...
     *         - last_90_days mixed stats for this user in the last 90 days
     ...
     *         - all_time mixed stats for the lifetime of the user's account
     ...
     *
     * @return mixed a mixed with one key "PING" with a static value "PONG!"
     */
