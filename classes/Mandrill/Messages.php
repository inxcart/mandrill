...
class Messages
{
     ...
     *                         - to[] mixed a single recipient's information.
     ...
     *                         - headers mixed optional extra headers to add to the message (most headers are allowed)
     ...
     *                         - global_merge_vars[] mixed a single global merge variable
     ...
     *                         - merge_vars[] mixed per-recipient merge variables
     ...
     *                         - vars[] mixed a single merge variable
     ...
     *                         - recipient_metadata[] mixed metadata for a single recipient
     ...
     *                         - attachments[] mixed a single supported attachment
     ...
     *                         - images[] mixed a single embedded image
     ...
     *
     * @return array of mixeds for each recipient containing the key "email" with the email address, and details of the message status for that recipient
     *     - return[] mixed the sending results for a single recipient
     *         - email string the email address of the recipient
     ...
     * @param array   $template_content an array of template content to send.  Each item in the array should be a mixed with two keys - name: the name of the content block to set the content for, and content: the actual content to put into the block
     *                                  - template_content[] mixed the injection of a single piece of content into a single editable region
     ...
     *
     * @return array of mixeds for each matching message
     *     - return[] mixed the information for a single matching message
     ...
     *             - opens_detail[] mixed information on an individual open
     ...
     *             - clicks_detail[] mixed information on an individual click
     ...
     *         - metadata mixed any custom metadata provided when the message was sent
     *     - smtp_events array a log of up to 3 smtp events for the message
     *         - smtp_events[] mixed information about a specific smtp event
     ...
     *     - return[] mixed the stats for a single hour
     ...
     *     - subject string the message's subject line
     *     - to mixed the message recipient's information
     *         - email string the email address of the recipient
     *         - name string the alias of the recipient (if any)
     *     - tags array list of tags on this message
     *         - tags[] string individual tag on this message
     *     - headers mixed the key-value pairs of the custom MIME headers for the message's main document
     ...
     *         - attachments[] mixed information about an individual attachment
     *             - name string the file name of the attachment
     *             - type string the MIME type of the attachment
     *             - content string the content of the attachment as a base64 encoded string
     */
     ...
     *         - to[] mixed the information on a single recipient
     *             - email string the email address of the recipient
     *             - name string the alias of the recipient (if any)
     *     - headers mixed the key-value pairs of the MIME headers for the message's main document
     *     - text string the text part of the message, if any
     *     - html string the HTML part of the message, if any
     *     - attachments array an array of any attachments that can be found in the message
     *         - attachments[] mixed information about an individual attachment
     ...
     *         - images[] mixed information about an individual image
     ...
     *     - return[] mixed a scheduled email
