...
class Tags
{
     ...
     *     - return[] mixed a user-defined tag
     ...
     *     - opens integer the total number of times messages with this tag have been opened
     *     - clicks integer the total number of times tracked URLs in messages with this tag have been clicked
     *     - stats mixed an aggregate summary of the tag's sending stats
     *         - today mixed stats with this tag so far today
     ...
     *         - last_7_days mixed stats with this tag in the last 7 days
     ...
     *         - last_30_days mixed stats with this tag in the last 30 days
     ...
     *         - last_60_days mixed stats with this tag in the last 60 days
     ...
     *         - last_90_days mixed stats with this tag in the last 90 days
