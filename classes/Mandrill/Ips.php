...
class Ips
{
     ...
     *
     * @return array an array of mixeds for each dedicated IP
     *     - return[] mixed information about a single dedicated IP
     ...
     *         - custom_dns mixed information about the ip's custom dns, if it has been configured
     ...
     *         - warmup mixed information about the ip's warmup status
     ...
     *     - return[] mixed information about each dedicated IP pool
     ...
     *             - ips[] mixed information about each dedicated IP
     *                 - ip string the ip address
     *                 - created_at string the date and time that the dedicated IP was created as a UTC string in YYYY-MM-DD HH:MM:SS format
     *                 - pool string the name of the pool that this dedicated IP belongs to
     *                 - domain string the domain name (reverse dns) of this dedicated IP
